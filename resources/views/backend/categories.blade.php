                ...
                <div class="modal-body">
                    <form id="main-category-edit-form" autocomplete="off" >
                        ...
                        <div class="form-group row">
                            <label for="edit-mc-name" class="col-sm-2 col-form-label">Name:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="edit-mc-name" name="name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="edit-mc-description" class="col-sm-2 col-form-label">Description:</label>
                            <div class="col-sm-9">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="main-category-create-form" autocomplete="off" >
                        @csrf
                        <div class="form-group row">
                            <label for="create-mc-name" class="col-sm-2 col-form-label">Name:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="create-mc-name" name="name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="create-mc-description" class="col-sm-2 col-form-label">Description:</label>
                            <div class="col-sm-9">
                ...
                <div class="modal-footer bg-light">
                    <button id="main-category-create-btn" type="button" class="btn btn-primary btn-fixed-150">Create</button>
                    <button type="button" class="btn btn-secondary btn-fixed-150" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="sub-category-create-modal" tabindex="-1" role="dialog" aria-labelledby="sub-category-create-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="sub-category-create-form" autocomplete="off" >
                        @csrf
                        <div class="form-group row">
                            <label for="create-sc-name" class="col-sm-2 col-form-label">Name:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="create-sc-name" name="name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="create-sc-category-id" class="col-sm-2 col-form-label">Category:</label>
                            <div class="col-sm-9">
                                <select id="create-sc-category-id" name="category_id" style="width: 100%">
                                    <option value=""></option>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            <label for="create-sc-description" class="col-sm-2 col-form-label">Description:</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="create-sc-description" name="description" style="height: 350px"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
